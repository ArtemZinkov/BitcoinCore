...
public protocol ITransactionCreator {
    ...
    func create(from: UnspentOutput, to address: String, feeRate: Int, sortType: TransactionDataSortType, forceSign: Bool) throws -> FullTransaction
...
protocol ITransactionBuilder {
    ...
    func buildTransaction(from: UnspentOutput, toAddress: String, feeRate: Int, sortType: TransactionDataSortType, forceSign: Bool) throws -> FullTransaction
}
